...
i18ndude rebuild-pot --pot sc.base.uploader.pot --create sc.base.uploader --merge manual.pot ..

# finally, update the po files
i18ndude sync --pot sc.base.uploader.pot  `find . -iregex '.*\.po$'|grep -v plone`
